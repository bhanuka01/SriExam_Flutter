...
class BusinessStudies extends StatefulWidget {
  const BusinessStudies({super.key});

  @override
  State<BusinessStudies> createState() => _CmathsState();
}

class _CmathsState extends State<BusinessStudies> {
  ...
  Future<Cmathsjson> getDataFromAPI() async {
    Uri uri = Uri.parse("https://bhanuka01.github.io/alapi/com/busistudy.json");
