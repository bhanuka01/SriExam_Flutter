...
class Agry extends StatefulWidget {
  const Agry({super.key});

  @override
  State<Agry> createState() => _CmathsState();
}

class _CmathsState extends State<Agry> {
  ...
  Future<Cmathsjson> getDataFromAPI() async {
    Uri uri = Uri.parse("https://bhanuka01.github.io/alapi/science/agry.json");
