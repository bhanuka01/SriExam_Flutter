...
class Civic extends StatefulWidget {
  @override
  State<Civic> createState() => _CmathsState();
}

class _CmathsState extends State<Civic> {
  ...
  Future<Cmathsjson> getDataFromAPI() async {
    Uri uri = Uri.parse("https://bhanuka01.github.io/alapi/tech/civic.json");
