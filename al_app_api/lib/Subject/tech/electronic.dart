...
class Electronic extends StatefulWidget {
  ...
  @override
  State<Electronic> createState() => _CmathsState();
}

class _CmathsState extends State<Electronic> {
  ...
  Future<Cmathsjson> getDataFromAPI() async {
    Uri uri = Uri.parse("https://bhanuka01.github.io/alapi/tech/electro.json");
