...
class Mechanical extends StatefulWidget {
  ...
  @override
  State<Mechanical> createState() => _CmathsState();
}

class _CmathsState extends State<Mechanical> {
  ...
  Future<Cmathsjson> getDataFromAPI() async {
    Uri uri = Uri.parse("https://bhanuka01.github.io/alapi/tech/mechanic.json");
