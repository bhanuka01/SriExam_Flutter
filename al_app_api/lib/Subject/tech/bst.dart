...
class SFT extends StatefulWidget {
  @override
  State<SFT> createState() => _CmathsState();
}

class _CmathsState extends State<SFT> {
  ...
  Future<Cmathsjson> getDataFromAPI() async {
    Uri uri = Uri.parse("https://bhanuka01.github.io/alapi/tech/bst.json");
